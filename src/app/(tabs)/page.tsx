...
export default function Home() {
  return (
    <main className="flex flex-col gap-[40px]">
      <section className="flex flex-col items-center gap-[39px]">
        ...
        <Button href="/products" className="w-[343px]">
          서비스 보러가기
        </Button>
      </section>
      ...
      <section className="flex flex-col items-center gap-[48px]">
        ...
        <section className="flex w-full flex-col items-center gap-[24px] px-[24px]">
          ...
          <div className="body_r_14 w-full text-[var(--color-gray-200)]">
            ...
            <p>
              <span className="head_b_14">Now Loading Next DIVE... 99%</span>
              <br />
        ...
        <section className="flex w-full flex-col gap-[56px] px-[16px]">
          <section className="flex flex-col gap-[24px]">
            <TagMain>행사 개요</TagMain>
            <div className="flex gap-[16px] px-[4px]">
          ...
          <section className="flex flex-col gap-[24px]">
            ...
            <p className="body_r_14 text-[var(--color-gray-300)]">
              이번 앱잼 데모데이 &lt;System Update: SUNRISE&gt;에서는 SOPT의 꽃
              앱잼(APPJAM) 뿐만 아니라 SOPT를 위한 프로덕트를 만드는
          ...
          <section className="flex flex-col gap-[24px]">
            ...
            <div className="body_r_14 text-[var(--color-gray-300)]">
              <p className="mb-[10px]">
              ...
              <p>
                SOPT는 Shout Our Passion Together라는 이름 뜻처럼, 앞으로도 많은
                사람들의 열정을 외치며 더욱 크게 도전하고자 합니다.
              </p>
            </div>
          </section>
        </section>
        ...
        <section className="flex w-full flex-col gap-[56px] px-[16px] pb-[24px]">
          <section className="flex flex-col gap-[12px]">
            ...
            <div className="flex flex-col gap-[8px]">
              <div className="flex items-center justify-end gap-[4px] text-[var(--color-gray-400)]">
